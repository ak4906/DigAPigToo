        ...
        if let giHistologyCat = categories.first(where: { $0.name == "Gastrointestinal Histology" }) {
            structures.append(contentsOf: [
                AnatomyStructure(categoryId: giHistologyCat.id, name: "Mucosa (Esophagus)", aliases: ["Esophageal mucosa", "Stratified squamous epithelium (esophagus)"],
                    function: "Innermost wall layer of the esophagus. IMPORTANT: the 'mucosa' is not just the epithelium — it is THREE sublayers together: (1) epithelium (non-keratinized stratified squamous), (2) lamina propria (loose connective tissue beneath the epithelium), and (3) muscularis mucosae (a thin smooth-muscle layer at its base). All three together = the mucosa.",
                    commonConfusions: ["Students often think 'mucosa' = only the epithelium — but mucosa = epithelium + lamina propria + muscularis mucosae (all three)", "The epithelium is non-KERATINIZED stratified squamous (unlike skin) — it stays moist and flexible while still resisting abrasion from food", "Boundary check: the muscularis mucosae is the deepest part of the mucosa and marks where the mucosa ends and the submucosa begins"],
                    examTips: ["KEY esophagus feature: non-keratinized stratified squamous epithelium", "On the slide, define all three mucosal sublayers: epithelium → lamina propria → muscularis mucosae", "Why stratified squamous here? Protection against mechanical abrasion from swallowed food; non-keratinized because the surface stays wet"],
                    images: [ImageCDN.slide("mucosa-esophagus_histo_1.jpeg", magnification: 4, caption: "Mucosa (Esophagus) — 4×")],
                    histology: "Three sublayers: (1) non-keratinized stratified squamous epithelium; (2) lamina propria (loose connective tissue, may contain small vessels/lymphoid tissue); (3) muscularis mucosae (thin, mostly longitudinal smooth muscle)"),
                AnatomyStructure(categoryId: giHistologyCat.id, name: "Muscularis Mucosae (Esophagus)", aliases: ["Muscularis mucosa (esophagus)"],
                    function: "The deepest of the three mucosal sublayers — a thin smooth-muscle band forming the base/boundary of the mucosa (predominantly longitudinal in the esophagus). Do not confuse with the much thicker muscularis externa further out in the wall.",
                    commonConfusions: ["Muscularis MUCOSAE (thin, part of the mucosa) vs muscularis EXTERNA/propria (thick, drives peristalsis, deeper in the wall) — different layers", "It is the LANDMARK separating the mucosa from the submucosa"],
                    examTips: ["Thin pink smooth-muscle line at the base of the mucosa", "Use it to divide the wall: everything luminal to it = mucosa; everything deep to it = submucosa and beyond"],
                    images: [ImageCDN.slide("muscularis-mucosae-esophagus_histo_1.jpeg", magnification: 4, caption: "Muscularis Mucosae (Esophagus) — 4×")],
                    histology: "Thin, mostly longitudinally-oriented smooth muscle layer"),
                AnatomyStructure(categoryId: giHistologyCat.id, name: "Submucosa (Esophagus)", aliases: ["Esophageal submucosa"],
                    function: "Connective-tissue layer just deep to the mucosa (deep to the muscularis mucosae). Its hallmark esophageal feature is the presence of esophageal (submucosal) mucous glands, whose ducts pass up through the mucosa to lubricate the lumen. Also carries larger blood vessels, and Meissner's (submucosal) nerve plexus/ganglia.",
                    commonConfusions: ["Esophageal submucosal glands are a defining feature — but they are not caught in every section, so a given slide may not show them", "Duct check (per the handout): esophageal gland ducts have a two-layered stratified cuboidal epithelium", "Contains parasympathetic (Meissner's) ganglia — look for them here and at the muscle-layer junction"],
                    examTips: ["Look DEEP to the muscularis mucosae for glands = submucosal mucous glands (esophagus clue)", "Identify vessels here as artery vs vein; find nerves and autonomic ganglia in the connective tissue"],
                    images: [ImageCDN.slide("submucosa-esophagus_histo_1.jpeg", magnification: 4, caption: "Submucosa (Esophagus) — 4×")],
                    histology: "Loose/dense irregular connective tissue containing esophageal mucous glands (ducts with two-layered stratified cuboidal epithelium), larger blood vessels, lymphatics, and Meissner's submucosal nerve plexus"),
                AnatomyStructure(categoryId: giHistologyCat.id, name: "Inner Muscle Layer (Esophagus)", aliases: ["Inner circular layer (esophagus)", "Inner circular muscularis externa (esophagus)"],
                    function: "Inner CIRCULAR layer of the muscularis externa (muscularis propria) — the thick muscle coat that produces peristalsis. Cut in cross-section it wraps the lumen as a ring. NOTE: esophageal muscularis externa is a mix of skeletal and smooth muscle depending on level (upper third skeletal, middle mixed, lower smooth).",
                    commonConfusions: ["This is the muscularis EXTERNA (thick, peristalsis) — not the thin muscularis mucosae up in the mucosa", "Muscle TYPE varies by level: upper 1/3 skeletal, middle 1/3 mixed, lower 1/3 smooth — so voluntary control tapers to involuntary as you descend"],
                    examTips: ["Inner circular = fibers cut so they encircle the lumen (ring-like)", "Auerbach's (myenteric) plexus/ganglia sit between the inner circular and outer longitudinal layers"],
                    images: [ImageCDN.slide("inner-muscle-layer-esophagus_histo_1.jpeg", magnification: 4, caption: "Inner Muscle Layer (Esophagus) — 4×")],
                    histology: "Circular layer of the muscularis externa; skeletal, smooth, or mixed muscle depending on esophageal level"),
                AnatomyStructure(categoryId: giHistologyCat.id, name: "Outer Muscle Layer (Esophagus)", aliases: ["Outer longitudinal layer (esophagus)", "Outer longitudinal muscularis externa (esophagus)"],
                    function: "Outer LONGITUDINAL layer of the muscularis externa. Together with the inner circular layer it drives peristalsis. Same skeletal-to-smooth gradient down the esophagus.",
                    commonConfusions: ["Outer longitudinal vs inner circular — cross-section: longitudinal fibers are cut lengthwise (elongated profiles), circular fibers appear as rings", "Still muscularis externa, not muscularis mucosae"],
                    examTips: ["Auerbach's (myenteric) plexus lies at the junction between this outer longitudinal and the inner circular layer — a good place to hunt for autonomic ganglia", "Functional point of the skeletal→smooth gradient: swallowing starts under voluntary (skeletal) control and becomes involuntary (smooth) lower down"],
                    images: [ImageCDN.slide("outer-muscle-layer-esophagus_histo_1.jpeg", magnification: 4, caption: "Outer Muscle Layer (Esophagus) — 4×")],
                    histology: "Longitudinal layer of the muscularis externa; skeletal, smooth, or mixed muscle depending on level; Auerbach's plexus between the two muscle layers"),
                AnatomyStructure(categoryId: giHistologyCat.id, name: "Adventitia (Esophagus)", aliases: ["Esophageal adventitia"],
                    function: "Outermost connective-tissue layer anchoring the thoracic esophagus to surrounding structures. The esophagus has ADVENTITIA (not serosa) along its thoracic course because it is fixed in the mediastinum; only the short abdominal segment below the diaphragm has a serosa.",
                    commonConfusions: ["Adventitia (anchoring connective tissue, fixed organ) vs serosa (slippery mesothelium, mobile organ) — esophagus is mostly adventitia", "Often hard to appreciate on a slide — it blends into surrounding tissue and may be trimmed away"],
                    examTips: ["Outermost, wispy connective-tissue layer with no clear mesothelial boundary = adventitia", "Contrast with the stomach/intestine, which have a true serosa"],
                    images: [ImageCDN.slide("adventitia-esophagus_histo_1.jpeg", magnification: 4, caption: "Adventitia (Esophagus) — 4×")],
                    histology: "Loose connective tissue with vessels and nerves, blending into surrounding mediastinal tissue; no mesothelial lining (except the short abdominal segment, which has serosa)"),
            ])
        }
